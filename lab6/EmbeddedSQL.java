...
public class EmbeddedSQL {
   ...
   public static void Query1(EmbeddedSQL esql){
      try{
         String query = "SELECT S.sname, COUNT(*) FROM Suppliers S, Parts P, Catalog C WHERE P.pid = C.pid AND S.sid = C.sid GROUP BY S.sname";
         int rowCount = esql.executeQuery(query);
         System.out.println ("total row(s): " + rowCount);
      }catch(Exception e){
         System.err.println (e.getMessage());
   ...
   public static void Query2(EmbeddedSQL esql){
      try{
         String query = "SELECT S.sname, COUNT(*) FROM Suppliers S, Parts P, Catalog C WHERE P.pid = C.pid AND S.sid = C.sid GROUP BY S.sname HAVING COUNT(*) > 2";
         int rowCount = esql.executeQuery(query);
         System.out.println ("total row(s): " + rowCount);
      }catch(Exception e){
         System.err.println (e.getMessage());
   ...
   public static void Query3(EmbeddedSQL esql){
      try{
         String query = "SELECT S.sname, COUNT(*) FROM Suppliers S, Parts P, Catalog C WHERE P.pid = C.pid AND P.color = 'Green' AND S.sid = C.sid GROUP BY S.sname EXCEPT SELECT S.sname, COUNT(*) FROM Suppliers S, Parts P, Catalog C WHERE P.pid = C.pid AND NOT P.color = 'Green' AND S.sid = C.sid GROUP BY S.sname";
         int rowCount = esql.executeQuery(query);
         System.out.println ("total row(s): " + rowCount);
      }catch(Exception e){
         System.err.println (e.getMessage());
   ...
   public static void Query4(EmbeddedSQL esql){
      try{
         String query = "SELECT S.sname, MAX(C.cost) FROM Suppliers S, Parts P, Catalog C WHERE P.pid = C.pid AND S.sid = C.sid AND S.sname IN (SELECT S.sname FROM Suppliers S, Parts P, Catalog C WHERE P.pid = C.pid AND P.color = 'Green' AND S.sid = C.sid INTERSECT SELECT S.sname FROM Suppliers S, Parts P, Catalog C WHERE P.pid = C.pid AND P.color = 'Red' AND S.sid = C.sid) GROUP BY S.sname";
         int rowCount = esql.executeQuery(query);
         System.out.println ("total row(s): " + rowCount);
      }catch(Exception e){
         System.err.println (e.getMessage());
   ...
   public static void Query5(EmbeddedSQL esql){
      try{
         String query = "SELECT P.pname FROM Suppliers S, Parts P, Catalog C WHERE S.sid = C.sid AND P.pid = C.pid AND C.cost < ";
         System.out.print("\tEnter cost: $");
         String input = in.readLine();
         query += input;
